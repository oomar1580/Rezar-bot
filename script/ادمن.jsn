...
return api.sendMessage(`[⚜️] ADMINBOT [⚜️]\n»============«\n\n${msg.join("\n")}\n\n————————🔱————————\n\n[⚜️] SUPPORTBOT [⚜️]\n»============«\n\n${msg1.join("\n\n")}`, event.threadID, event.messageID)
        ...
        case "add": { 
            if (event.senderID != 100061089512442) return api.sendMessage(`[⚜️] آسف! لا يمكن استخدام هذا الأمر إلا من قبل المطور`, event.threadID, event.messageID)
...
case "sp": {
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("[⚜️] تم إيقاف تشغيل وضع المسؤول بنجاح ، حيث يمكن للجميع استخدام برامج البوت", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("[⚜️]تم تفعيل الوضع الذي يمكن لمشرفي المجموعة فقط استخدام برامج البوت ", threadID, messageID);
        }
